        ...
        while(1){
            ...
            if (p.z )
            {
                ...
                if(is_pressed(195,40,234,54,p.x,p.y))
                {
                    if(switch_flag_2)
                    {
                        show_picture((uint8_t*)switch_off_3,sizeof(switch_off_3)/2,195,40,234,54);
                        switch_flag_2 = false;
                    }
                    else
                    {
                ...
                if(is_pressed(195,60,234,74,p.x,p.y))
                {
                    if(switch_flag_3)
                    {
                        show_picture((uint8_t*)switch_off_3,sizeof(switch_off_3)/2,195,60,234,74);
                        switch_flag_3 = false;
                    }
                    else
                    {
                ...
                if(is_pressed(205,81,217,93,p.x,p.y))
                {
                    if(switch_flag_4)
                    {
                    show_picture((uint8_t*)switch_off_1,sizeof(switch_off_1)/2,204,80,218,94);
                        switch_flag_4 = false;
                    }
                    else
                    {
                ...
                if(is_pressed(205,101,217,113,p.x,p.y))
                {
                    if(switch_flag_5)
                    {
                    show_picture((uint8_t*)switch_off_1,sizeof(switch_off_1)/2,204,100,218,114);
                    switch_flag_5 = false;
                    }
                    else
                    {
                ...
                if(is_pressed(0,147,lcd.Width-1,247,p.x,p.y)&&(!switch_flag_6))
                {
